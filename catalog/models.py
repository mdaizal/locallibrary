...
class Language(models.Model):
    ...
    # TODO: Define fields here
    language = models.CharField(max_length=200, help_text='Enter the book language (e.g. Malay, Farsi etc)')
    # class Meta:
...
class Book(models.Model):
    ...
    # ManyToManyField used because language can contain many books. Books can have many languages (translated books).
    # Genre (and Language) class has already been defined so we can specify the object above.

...
class Language(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text='Enter the book language(e.g. Malay, Farsi etc)'
    )
...
class Book(models.Model):
    ...
    # have multiple books.Author as a string rather than object because
    # it hasn't been declared yet in the file.
    summary = models.TextField(
        max_length=1000, help_text='Enter a brief description of the book')
    isbn = models.CharField(
        'ISBN', max_length=13, help_text='13 Character ' +
    ...
    # ManyToManyField used because language can contain many books.
    # Books can have many languages (translated books).
    # Genre (and Language) class has already been defined so we
    # can specify the object above.
    ...
    def display_language(self):
        ...
        """
        return ', '.join([language.name for language in
                          self.language.all()[:3]])
